...
if uploaded_file:
    ...
    # Menampilkan data setelah semua langkah
    st.subheader("Hasil Akhir: Data Setelah Pembersihan, Stopwords, dan Stemming")
    st.write(f_busu_clean[['content', 'text_clean', 'text_StopWord', 'text_stemmed']].head(10))
