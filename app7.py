...
# Streamlit setup
st.set_page_config(page_title="Analisis Sentimen Aplikasi Info BMKG", page_icon="🌍", layout="wide")
st.title("Analisis Sentimen Ulasan Penggunaan Aplikasi Info BMKG")
st.markdown("**Visualisasi data mentah dan hasil proses pembersihan data secara bertahap.**")
...
if uploaded_file:
    ...
    # Menampilkan matriks kebingunguan dengan styling
    cm = confusion_matrix(y_test, y_pred)
    plt.figure(figsize=(8, 6))
    sns.heatmap(cm, annot=True, fmt='d', cmap='Blues', xticklabels=['Negatif', 'Netral', 'Positif'], yticklabels=['Negatif', 'Netral', 'Positif'])
    plt.title('Matriks Kebingunguan', fontsize=16)
